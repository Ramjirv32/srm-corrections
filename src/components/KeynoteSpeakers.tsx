        ...
        <header className="bg-gradient-to-r from-blue-900 to-[#F5A051] text-white py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-xl md:text-2xl opacity-90 max-w-3xl">
              Distinguished experts sharing insights at ICMBNT 2025
            </p>
          </div>
        </header>
        ...
        <main className="container mx-auto py-12 px-4">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            ...
            <p className="text-lg text-gray-600">
              We are honored to present our distinguished keynote speakers for ICMBNT 2025. These renowned experts 
