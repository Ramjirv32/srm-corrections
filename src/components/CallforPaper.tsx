        ...
        <section className="mb-16">
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
            <ol className="list-decimal pl-5 space-y-5">
              ...
              <li className="text-gray-700">
                ICMBNT 2025 organizers regard plagiarism as a serious professional misconduct. All
              ...
              <li className="text-gray-700">
                Authors must submit their manuscript to the Email- ID: <a href="mailto:icmbnt2025@gmail.com" className="text-[#F5A051] hover:underline">icmbnt2025@gmail.com</a>
              </li>
            </ol>
